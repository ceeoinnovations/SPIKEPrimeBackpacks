...
Summary: This code sends a 1 or a 0 to the SPIKE Prime depending on whether 
a button switch connected on Pin X2 is pressed or not

Attribution: https://docs.micropython.org/en/latest/pyboard/quickref.html#pins-and-gpio
...
p_in = Pin('X2', Pin.IN, Pin.PULL_DOWN)
