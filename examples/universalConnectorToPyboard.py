'''
Device: Pyboard 
Summary: This code sends numbers 0 through 9 from Pyboard to LEGO SPIKE Prime

Connection: 
RX Tx 3v3 Gnd M+ M-

Pyboard Tx to SPIKE Prime Rx 
Pyboard Rx to SPIKE Prime Tx
Pyboard Ground to SPIKE Prime Ground 
...
lpf2 = LPF2.Prime_LPF2(3, 'Y9', 'Y10', modes, LPF2.SPIKE_Ultrasonic, timer = 4, freq = 5)    # PyBoard UART3
#lpf2 = LPF2.Prime_LPF2(1, 'Y1', 'Y2', modes, LPF2.SPIKE_Ultrasonic, timer = 4, freq = 5)    # PyBoard UART1
