...
Summary: This code reads a value of 1 if button is pressed or 0 if button is not pressed, and 
sends the corresponding values to LEGO SPIKE Prime

Attribures: http://wiki.seeedstudio.com/Grove-Button/
